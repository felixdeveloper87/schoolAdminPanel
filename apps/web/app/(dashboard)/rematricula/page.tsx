  ...
  return (
    <div className="space-y-7">
      ...
      <Card className="overflow-hidden rounded-[22px] border-border bg-card/95 shadow-[0_14px_40px_rgba(35,49,79,.07)]">
        <div className="flex items-center gap-3 border-b border-border px-5 py-4"><span className="grid h-10 w-10 place-items-center rounded-xl bg-brand/10 text-brand"><GraduationCap className="h-5 w-5" /></span><div><h2 className="font-display text-lg font-extrabold">Status por aluno</h2><p className="text-xs text-muted-foreground">Clique em “Criar acordo” ou “Ver acordo” para abrir os detalhes.</p></div></div>
        <Table>
          <TableHeader className="bg-muted/60"><TableRow><TableHead className="pl-5">Aluno</TableHead><TableHead className="hidden sm:table-cell">Turma</TableHead><TableHead>Status e acordo</TableHead></TableRow></TableHeader>
          <TableBody>
